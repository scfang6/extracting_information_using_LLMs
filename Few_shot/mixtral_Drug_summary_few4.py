...
filename = 'mixtral_Drug_summary_few4'
...
Please summarize the content related to current medications.
...
for i, letter in enumerate(tqdm(letters)):
    result2 = llm(prompt2.format(query=letter))
    q = a+result2+end_format
